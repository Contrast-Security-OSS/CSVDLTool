...
- Windows  
  ...
  - 署名  
    ...
    sign4j.exe java -jar jsign-2.0.jar --alias 1 --keystore C:\Users\turbou\Desktop\CSVDLTool_work\XXXXX.pfx --storepass [パスワード] C:\Users\turbou\Desktop\CSVDLTool_work\common\CSVDLTool_1.5.2.exe
    ```
  - 署名の確認  
...
- Mac
  ...
  - 署名
    ```bash
    codesign --deep -s "Contrast Security, Inc." -v CSVDLTool_1.5.2.app
    ```
  - 署名の確認
    ```bash
    codesign -d --verbose=4 CSVDLTool_1.5.2.app
    ```
...
- Mac
  ```bash
  7z a CSVDLTool_1.5.2.cli7z CSVDLTool_1.5.2.app/
  ```
