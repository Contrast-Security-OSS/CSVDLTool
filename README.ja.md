...
- 署名  
  ...
  sign4j.exe java -jar jsign-2.0.jar --alias 1 --keystore C:\Users\turbou\Desktop\CSVDLTool_work\XXXXX.pfx --storepass [パスワード] C:\Users\turbou\Desktop\CSVDLTool_work\common\CSVDLTool_2.1.1.exe
  ```
- 署名の確認  
...
- 署名
  ```bash
  codesign --deep -s "Contrast Security, Inc." -v CSVDLTool_2.1.1.app
  codesign --deep -s "Contrast Security, Inc." -v CSVDLTool_2.1.1_auditlog.app
  ```
- 署名の確認
  ```bash
  codesign -d --verbose=4 CSVDLTool_2.1.1.app
  codesign -d --verbose=4 CSVDLTool_2.1.1_auditlog.app
  ```
    
#### 圧縮について補足
- macOS
  ```bash
  7z a CSVDLTool_2.1.1.cli7z CSVDLTool_2.1.1.app/
  7z a CSVDLTool_2.1.1_auditlog.cli7z CSVDLTool_2.1.1_auditlog.app/
  ```
